...
- Jira Release Overview: https://eaflood.atlassian.net/projects/FSR/versions/27366/tab/release-report-all-issues
...
- Add additional Jira tickets from the related release notes in the 'Release 8.24.0' PR's created in:
...
- FSR-1505 | New 5 Day Forecast Implementation (#1030)
  
- FSR-1268 | Browser Back Clears Search Results (#1074)
