...
window.flood = {
  utils: {
    ...
    setGTagAnalyticsCookies: () => {
      ...
      const gtagFunc = function (w, d, s, l, i) {
        w[l] = w[l] || []
        w[l].push({
      ...
      gtagManager.onload = gtagFunc(window, document, 'script', 'dataLayer', 'G-TM9QYEJJPC')
      ...
      iframe.setAttribute('src', 'https://www.googletagmanager.com/ns.html?id=G-XNV5TZXSTT')
