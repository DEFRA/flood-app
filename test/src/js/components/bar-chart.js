...
//   it('The hours and minutes controls are rendered with hours as the default', async () => {
//     // Arrange
...
//   it('The 24 hours control switches the chart to 24 hour range', async () => {
//     // Arrange
//     const chartId = 'example-chart-id'
//     const telemetry = telemetryFixture
//     const chartContainer = document.createElement('div')
...
//   it('The pagination buttons are shown when the chart is in the 24 hour range', async () => {
//     // Arrange
//     const chartId = 'example-chart-id'
//     const telemetry = telemetryFixture
//     const chartContainer = document.createElement('div')
...
//   it('The pagination buttons are not shown when the chart is in the 5 day range', async () => {
//     // Arrange
//     const chartId = 'example-chart-id'
//     const telemetry = telemetryFixture
//     const chartContainer = document.createElement('div')
...
//   it('The pagination buttons allow changing the page range', async () => {
//     // Arrange
//     const chartId = 'example-chart-id'
//     const telemetry = telemetryFixture
//     const chartContainer = document.createElement('div')
