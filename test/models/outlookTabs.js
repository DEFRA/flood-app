...
lab.experiment('outlookTabs model test', () => {
  lab.test('Test OutlookTabsModel', async () => {
    ...
    const polys = { polys: [{ tab: 'tomorrow', riskLevel: 1, source: 'river', impact: 2, likelihood: 2, day: 2, messageId: '1-i2-l2', polyId: 3304 }, { tab: 'outlook', riskLevel: 1, source: 'river', impact: 2, likelihood: 2, day: 3, messageId: '1-i2-l2', polyId: 3302 }, { tab: 'outlook', riskLevel: 1, source: 'surface', impact: 2, likelihood: 2, day: 3, messageId: '1-i2-l2', polyId: 3302 }, { tab: 'outlook', riskLevel: 1, source: 'river', impact: 2, likelihood: 2, day: 4, messageId: '1-i2-l2', polyId: 3302 }, { tab: 'outlook', riskLevel: 1, source: 'surface', impact: 2, likelihood: 2, day: 4, messageId: '1-i2-l2', polyId: 3302 }, { tab: 'outlook', riskLevel: 1, source: 'river', impact: 2, likelihood: 2, day: 5, messageId: '1-i2-l2', polyId: 3302 }, { tab: 'outlook', riskLevel: 1, source: 'surface', impact: 2, likelihood: 2, day: 5, messageId: '1-i2-l2', polyId: 3302 }, { tab: 'outlook', riskLevel: 2, source: 'river', impact: 2, likelihood: 4, day: 4, messageId: '2-i2-l4', polyId: 3301 }, { tab: 'outlook', riskLevel: 2, source: 'river', impact: 2, likelihood: 4, day: 5, messageId: '2-i2-l4', polyId: 3301 }, { tab: 'today', riskLevel: 1, source: 'surface', impact: 2, likelihood: 2, day: 1, messageId: '1-i2-l2', polyId: 3300 }, { tab: 'tomorrow', riskLevel: 1, source: 'surface', impact: 2, likelihood: 2, day: 2, messageId: '1-i2-l2', polyId: 3300 }, { tab: 'today', riskLevel: 2, source: 'river', impact: 2, likelihood: 4, day: 1, messageId: '2-i2-l4', polyId: 3298 }, { tab: 'today', riskLevel: 3, source: 'river', impact: 3, likelihood: 4, day: 1, messageId: '3-i3-l4', polyId: 3297 }, { tab: 'tomorrow', riskLevel: 3, source: 'river', impact: 3, likelihood: 4, day: 2, messageId: '3-i3-l4', polyId: 3297 }, { tab: 'outlook', riskLevel: 3, source: 'river', impact: 3, likelihood: 4, day: 3, messageId: '3-i3-l4', polyId: 3297 }] }
    ...
    Code.expect(Result).to.equal(polys)
  })
})
