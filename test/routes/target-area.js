...
lab.experiment('Target-area tests', () => {
  ...
  lab.test('Check flood severity banner link for Flood warning and multi latest levels', async () => {
    ...
    Code.expect(response.payload).to.contain('<a href="/station/7173?tid=123465">Monitor the River Pinn level at Avenue Road</a>')
    ...
    Code.expect(response.payload).to.contain('<a href="/station/7201?tid=123457">Monitor the River Pinn level at Moss Close</a>')
  })
