...
lab.experiment('Routes test - rainfall-station-csv', () => {
  ...
  lab.test('GET /rainfall-station-csv rainfall station', async () => {
    ...
    Code.expect(response.result).to.equal('Timestamp (UTC),Rainfall (mm)\n2021-07-15T12:00:00Z,0.2')
