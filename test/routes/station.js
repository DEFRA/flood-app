...
lab.experiment('Test - /station/{id}', () => {
  ...
  lab.test('GET station/5146 with Normal river level ', async () => {
    ...
    Code.expect(response.payload).to.contain('<a href="/river-and-sea-levels/rloi/5146">Nearby levels</a>')
  ...
  lab.test('GET station/2042/downstream ', async () => {
    ...
    Code.expect(response.payload).to.contain('<a href="/river-and-sea-levels/rloi/2042">Nearby levels</a>')
  ...
  lab.test('GET station/7333 ffoi with max value ', async () => {
    ...
    Code.expect(response.payload).to.contain('<a href="/river-and-sea-levels/rloi/7333">Nearby levels</a>')
  })
