...
lab.experiment('Test - /station/{id}', () => {
  ...
  lab.test('GET station/5146 with Normal river level ', async () => {
    ...
    Code.expect(response.payload).to.contain('<a data-journey-click="Station:Station navigation:Station - Nearby levels" href="/river-and-sea-levels?rloi-id=5146" class="defra-flood-nav__link">Nearby levels</a>')
  ...
  lab.test('GET station/2042/downstream ', async () => {
    ...
    Code.expect(response.payload).to.contain('<a data-journey-click="Station:Station navigation:Station - Nearby levels" href="/river-and-sea-levels?rloi-id=2042" class="defra-flood-nav__link">Nearby levels</a>')
  ...
  lab.test('GET station/7333 ffoi with max value ', async () => {
    ...
    Code.expect(response.payload).to.contain('<a data-journey-click="Station:Station navigation:Station - Nearby levels" href="/river-and-sea-levels?rloi-id=7333" class="defra-flood-nav__link">Nearby levels</a>')
  })
